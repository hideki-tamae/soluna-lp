    ...
    <section className="relative py-24 md:py-48 bg-[#050511] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          {/* 右側：データポータル */}
          <div className="lg:col-span-7 relative group cursor-pointer perspective-1000 mt-4 md:mt-0">
            <Link href="/policy" className="block relative transform transition-all duration-700 hover:scale-[1.02] hover:-rotate-1">
              ...
              {/* メインカード */}
              <div className="relative rounded-[2rem] overflow-hidden border border-emerald-500/20 bg-[#0A0A12]/80 backdrop-blur-xl aspect-[4/3] md:aspect-video flex items-center justify-center shadow-2xl group-hover:border-emerald-400/40 transition-colors duration-500 p-6 md:p-0">
                   ...
                   {/* コンテンツ */}
                   <div className="relative z-10 text-center space-y-4 md:space-y-6 transform transition-transform duration-500 group-hover:scale-105">
                      ...
                      <div className="space-y-2">
                        <p className="text-[10px] md:text-xs font-bold tracking-[0.2em] text-emerald-500 uppercase">Real-time Analysis</p>
                        <p className="text-2xl md:text-5xl font-bold text-white tracking-tight">GBD Compare Data</p>
                        <p className="text-sm md:text-base text-gray-400">東京都 15-49歳 死因分析ヒートマップ</p>
                      </div>

                      <div className="pt-4 md:pt-6">
                        <span className="inline-flex items-center gap-2 text-xs md:text-sm text-emerald-300 font-medium bg-emerald-950/50 px-4 py-2 rounded-full border border-emerald-500/20 group-hover:bg-emerald-900/50 transition-colors">

...
const InversionSection = () => {
  const features = [
    {
      ...
      // 世界最高品質: 不可逆性を象徴する、多層ホログラフィック・キューブ
      icon: (
    ...
    },
    {
      ...
      // 世界最高品質: 分散型ネットワークを可視化する、デジタル・グローブ
      icon: (
  ...
  return (
    <section className="relative w-full py-32 md:py-48 bg-[#050511] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className={`group relative p-10 rounded-3xl bg-[#080816] border border-white/5 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:bg-[#0b0b1e] ${feature.borderGlow} ${feature.shadowGlow}`}
            >
              ...
              <div className="relative z-10 flex flex-col h-full items-center text-center">
                ...
                <div className="mb-12 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3">
                  {feature.icon}
                </div>
